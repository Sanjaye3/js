...
function AddMovie() {
  ...
  return (
    <div className="App">
      ...
      {movieList.map((item,index)=> <Movie key={index} movie={item}/> )}
      {/* <ColorBox /> */}
...
function Moviedetails( ){
  return(
    <div>
   <h1>Vikram</h1>
   <iframe width="100%" height="750" src= "https://www.youtube.com/embed/OKBMCL-frPU" title="VIKRAM - Official Trailer | Kamal Haasan | VijaySethupathi, FahadhFaasil | LokeshKanagaraj | Anirudh" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
  )
}
...
function Movie({movie}){
  ...
  return(
    <div className="movie-container">
      ...
      <IconButton aria-label="delete" color="primary" onClick={() => navigate("/moviedetails") }>
      < InfoIcon />  
</IconButton>
